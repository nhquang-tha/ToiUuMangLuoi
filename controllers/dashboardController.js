...
exports.getKpiData = async (req, res) => {
    ...
    try {
        ...
        if (type === 'keyword' && value) {
            ...
            if (values.length === 1) {
                // Thuật toán an toàn cho Tìm kiếm chéo giữa Cell_Name và Site_Name
        ...
        // Bổ sung giới hạn an toàn 10,000 dòng để chống sập RAM
        query += ` LIMIT 10000`; 
        ...
        // Trả về JSON để Frontend bắt lỗi mượt mà thay vì báo lỗi Server HTML 500
