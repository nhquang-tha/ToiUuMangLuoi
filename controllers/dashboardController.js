...
// Xử lý Upload và Import Data (RF và KPI)
exports.handleImportData = async (req, res) => {
    try {
        ...
        // Đọc file từ buffer RAM
        const workbook = xlsx.read(req.file.buffer, { type: 'buffer' });
        const sheetName = workbook.SheetNames[0];
        
        let data = [];
        
        // XỬ LÝ ĐẶC BIỆT: File KPI 4G có dòng đầu tiên là "Lọc KPI 4G theo điều kiện..." nên bị lỗi Header.
        // Dùng { range: 1 } để yêu cầu SheetJS bỏ qua hàng 0 và đọc Header từ hàng số 1.
        ...
        res.render('import_data', { 
            ...
            page: 'Import Data', 
            message: null, 
            error: 'Có lỗi xảy ra khi xử lý file. Vui lòng kiểm tra lại cấu trúc cột của file Excel/CSV, xem có thay đổi nào không.' 
        });
    }
};
